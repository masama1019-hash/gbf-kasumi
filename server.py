...
MEMBERS = [
    ...
    ("クラシック１", 3767386), ("えりゅ", 10408332), ("とくこ", 4984108),
    ("Ryan", 10219632), ("きぃ", 929001), ("はりま", 204160),
    ...
    ("皇杞枢", 22967234), ("しびー", 23600641), ("風色幻想", 25557296),
    ("レン", 12275867), ("じゅりこ", 38776098), ("さとう", 31919490),
]
